...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    // Make sure we have enough space for at least one more database log file, plus 5 MB
    if (nFreeBytesAvailable < (uint64)(DB_MAX_LOG_SIZE + 5*1024*1024) + nAdditionalBytes)
    {
        fShutdown = true;
